...
if (isset($_POST[USER_UID]) && isset($_POST[USER_TOKEN]) && isset($_POST[LATITUDE]) && isset($_POST[LONGITUDE])) {
    ...
    if($access) {
        ...
        if(isset($_POST[KEYWORD])){
        	...
        	$pages = $db->searchPagesAtLocation($user_lat, $user_long, $user_uid, $keyword, $cursor_checkin, $cursor_date, $pdo);
        }
        else{
        	$pages = $db->getPagesAtLocation($user_lat, $user_long, $user_uid, $cursor_checkin, $cursor_date, $pdo);
        } 
