    ...
    if($access) {
        ...
        if(isset($_POST[KEYWORD]) || isset($_POST[PAGE_CATEGORY])){
			...
			if(isset($_POST[PAGE_CATEGORY])){
        	 ...
        	 $pages = $db->searchUserFollowingPages($user_uid, $keyword, $category, $cursor_checkin, $cursor_date, $pdo);
        }
        else{
        	 $pages = $db->getUserFollowingPages($user_uid, $cursor_checkin, $cursor_date, $pdo);
        } 
